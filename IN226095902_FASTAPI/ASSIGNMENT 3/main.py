...
# ================================================================
#  EXISTING ENDPOINTS (from main_day4.py — do not modify)
# ================================================================
...
# DAY 4 : Update stock or price (PUT) — Q2
...
# DAY 4 : Delete product (DELETE) — Q3
...
# ================================================================
#  DAY 4 — Q5   GET /products/audit — Inventory Summary
#  IMPORTANT: placed ABOVE /products/{product_id}
# ================================================================
...
# ================================================================
#  DAY 4 — BONUS   PUT /products/discount — Category-Wide Discount
#  IMPORTANT: placed ABOVE /products/{product_id}
# ================================================================
...
# DAY 1 : Variable Route — must stay BELOW all fixed /products/... routes
